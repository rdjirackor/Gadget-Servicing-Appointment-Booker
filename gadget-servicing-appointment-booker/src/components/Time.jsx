...
const Time = ({ date }) => {
    ...
    const handleConfirm = () => {
        ...
        setSelectedTime(null); // Clear the selected time after confirmation
    };

    const handleReturn = () => {
        setSelectedTime(null); // Clear the selected time and hide the confirmation dialog
    };
        ...
        <div className="big-square">
            ...
            {selectedTime && !confirmedTime && (
                <div className="confirmation-box">
                    <p>You have selected {selectedTime} on {formattedDate}</p>
